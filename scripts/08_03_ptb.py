...
CODE OBTAINED FROM : https://github.com/tensorflow/tensorflow/blob/master/tensorflow/contrib/eager/python/examples/rnn_ptb/rnn_ptb.py
"""
...
def clip_gradients(grads_and_vars, clip_ratio):
  ...
  clipped = [tf.cast(g, tf.float32) for g in gradients]
